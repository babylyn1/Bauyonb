						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<ul> <span class="menu-text">School Year</span></ul>
														</a>
													</li>
										</ul>
									</div>
								...
								<	<li class="menu-item" aria-haspopup="true">
									...
									<ul> <span class="menu-text">Article</span></ul>
														</a>
													</li>
									<li class="menu-item" aria-haspopup="true">
									<a href="{{ url('post')}}" class="menu-link">
									<i class="flaticon2-add"></i>
									<ul> <span class="menu-text">Post</span></ul>
														</a>
													</li>
													<li class="menu-item" aria-haspopup="true">
									<a href="{{ url('messages')}}" class="menu-link">
									<i class="flaticon2-chat-1"></i>
									<ul> <span class="menu-text">Message</span></ul>
														</a>
													</li>
											<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                ...
                                <ul> <span class="menu-text">Permission</span> </ul>
                                </a>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                ...
                                <ul> <span class="menu-text">Role</span> </ul>
                                </a>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                ...
                                <ul> <span class="menu-text">User</span> </ul>
                                </a>
