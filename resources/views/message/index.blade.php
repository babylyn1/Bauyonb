...
<div class="d-flex flex-row">
    <!--begin::Aside-->
    <div class="flex-row-auto offcanvas-mobile w-350px w-xl-450px" id="kt_chat_aside">
        <!--begin::Card-->
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M11,16 C13.7614237,16 16,13.7614237 16,11 C16,8.23857625 13.7614237,6 11,6 C8.23857625,6 6,8.23857625 6,11 C6,13.7614237 8.23857625,16 11,16 Z M11,18 C7.13400675,18 4,14.8659932 4,11 C4,7.13400675 7.13400675,4 11,4 C14.8659932,4 18,7.13400675 18,11 C18,14.8659932 14.8659932,18 11,18 Z" fill="#000000" fill-rule="nonzero"></path>
                ...
                <!--begin:Users-->
                <div class="mt-7 scroll scroll-pull ps ps--active-y" style="height: 428px; overflow: hidden;">
                    <!--begin:User-->
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-circle symbol-50 mr-3">
                            <img alt="Pic" src="assets/media/users/1.jpg">
                            </div>
                            <div class="d-flex flex-column">
                                <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">Lyn</a>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-circle symbol-50 mr-3">
                            <img alt="Pic" src="assets/media/users/2.jpg">
                            </div>
                            <div class="d-flex flex-column">
                                <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">Baby</a>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-circle symbol-50 mr-3">
                            <img alt="Pic" src="assets/media/users/3.jpg">
                            </div>
                            <div class="d-flex flex-column">
                                <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">Alia</a>
                                <span class="text-muted font-weight-bold font-size-sm">4lyf<3</span>
                            </div>
                        </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-circle symbol-50 mr-3">
                            <img alt="Pic" src="assets/media/users/4.jpg">
                            </div>
                            <div class="d-flex flex-column">
                                <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">Nanay</a>
                                <span class="text-muted font-weight-bold font-size-sm">dragon</span>
                                <span class="text-dark-55 text-hover-primaryfont-weight-bold font-size-sm">ndi kpa ba pauwe</span>
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <span class="label label-sm label-danger">17</span>
                        </div>
                    </div>
                    <!--end:User-->
                ...
                <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 428px; right: -2px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 172px;"></div></div></div>
                <!--end:Users-->
            </div>
            <!--end::Body-->
        </div>
...
<!--end::Navigation-->
                ...
                <div class="text-center flex-grow-1">
                    <div class="text-dark-75 font-weight-bold font-size-h5">Lyn</div>
                    <div>
